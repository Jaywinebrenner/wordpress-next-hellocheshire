...
export async function getServerSideProps({params}) {
    ...
    const page = await fetch(`http://localhost:8888/wordpress-installation/wp-json/wp/v2/pages?slug=home&_embed`).then((res) => res.json());
...
// INDEX BEFORE OVERWRITING WITH THE [...SLUG] PAGE
// import HomeContent from '../components/parts/HomeContent';
// import Footer from '../components/parts/Footer'
